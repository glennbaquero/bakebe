...
class ActivityLogFetchController extends Controller
{
    ...
    public function filterQuery($query) 
    {
        ...
        $query = $this->filterSubject($query, 'coupons', 'App\Models\Coupons\Coupon');
        $query = $this->filterSubject($query, 'promos', 'App\Models\Promos\Promo');
        $query = $this->filterSubject($query, 'categories', 'App\Models\Pastries\Category');
        $query = $this->filterSubject($query, 'pastries', 'App\Models\Pastries\Pastry');
        $query = $this->filterSubject($query, 'intervals', 'App\Models\Intervals\BlockDateInterval');
        $query = $this->filterSubject($query, 'types', 'App\Models\Types\BookingType');
