		...
		<div class="dashboard--holder frm-cntnr">
			<div class="w-100 inlineBlock-parent">
						...
						<div class="frm-cntnr bg-white desktop-show">
							...
							<div class="w-80 mx-auto dash--menu">
								<ul class="pl-0">
									...
									<li class="mb-2"><small><a class="active" href="change-password">Change Password</a></small></li>
								</ul>
				...
				><div class="w-70 align-t">
					<div class="w-95 mx-auto dash--content bg-white py-8 shadow">
						<change-password submit-url="{{ route('web.user.update-password') }}">
						</change-password>
					</div>
				</div>
			</div>
