...
<div class="content-wrapper">
    ...
    <page-pagination fetch-url="{{ route('admin.coupons.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <coupons-view
                        fetch-url="{{ route('admin.coupons.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.coupons.update', $item->id) }}"
                        ></coupons-view>
                    </div>
                    <div class="tab-pane" id="tab2">
                        ...
                        disabled
                        no-action
                        fetch-url="{{ route('admin.activity-logs.fetch.coupons', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
