...
<div class="content-wrapper">
    ...
    <page-pagination fetch-url="{{ route('admin.invoices.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <invoices-view
                        fetch-url="{{ route('admin.invoices.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.invoices.update', $item->id) }}"
                        ></invoices-view>
                    </div>
                    <div class="tab-pane" id="tab2">
                        ...
                        disabled
                        no-action
                        fetch-url="{{ route('admin.activity-logs.fetch.invoices', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
