...
<div class="content-wrapper">
    ...
    <page-pagination fetch-url="{{ route('admin.branches.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <branches-view
                        fetch-url="{{ route('admin.branches.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.branches.update', $item->id) }}"
                    ...
                    <div class="tab-pane" id="tab2">
                        ...
                        disabled
                        no-action
                        fetch-url="{{ route('admin.activity-logs.fetch.branches', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
