...
@section('meta:title', 'Booking Types')
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Booking Types</a></li>
                </ol>
            </div>
        </div>
    </section>
                ...
                <div class="card-body">
                    <div class="tab-content">
                        <div class="tab-pane show active" id="tab1">
                            <types-table
                            ref="table-1"
                            fetch-url="{{ route('admin.types.fetch') }}"
                            ></types-table>
                        </div>
                        <div class="tab-pane" id="tab2">
                            ...
                            ref="table-2"
                            disabled
                            fetch-url="{{ route('admin.types.fetch-archive') }}"
                            ></types-table>
                        </div>
                    </div>
                </div>
