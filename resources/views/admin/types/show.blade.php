...
<div class="content-wrapper">
    ...
    <page-pagination fetch-url="{{ route('admin.types.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <types-view
                        fetch-url="{{ route('admin.types.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.types.update', $item->id) }}"
                        ></types-view>
                    </div>
                    <div class="tab-pane" id="tab2">
                        ...
                        disabled
                        no-action
                        fetch-url="{{ route('admin.activity-logs.fetch.types', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
