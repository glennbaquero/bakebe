...
<div class="content-wrapper">
    ...
    <page-pagination fetch-url="{{ route('admin.categories.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <categories-view
                        fetch-url="{{ route('admin.categories.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.categories.update', $item->id) }}"
                        ></categories-view>
                    </div>
                    <div class="tab-pane" id="tab2">
                        ...
                        disabled
                        no-action
                        fetch-url="{{ route('admin.activity-logs.fetch.categories', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
