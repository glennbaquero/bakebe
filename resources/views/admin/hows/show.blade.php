...
<div class="content-wrapper">
    ...
    <page-pagination fetch-url="{{ route('admin.hows.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <hows-view
                        fetch-url="{{ route('admin.hows.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.hows.update', $item->id) }}"
                        ></hows-view>
                    </div>
                    <div class="tab-pane" id="tab2">
                        ...
                        disabled
                        no-action
                        fetch-url="{{ route('admin.activity-logs.fetch.hows', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
